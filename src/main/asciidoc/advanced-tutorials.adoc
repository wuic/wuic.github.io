...
----
{
    "workflowTemplates" : [{
        "id" : "tpl"
        "without" : [{wuicDefaultMemoryMapCacheEngineBuilder}]
        "engineChain" : ["wuicDefaultEhCacheEngineBuilder", "wuicDefaultYuiCompressorJavascriptEngineBuilder", "wuicDefaultYuiCompressorCssEngineBuilder"]
    }], "workflows" : [{
        "idPrefix" : "my-",
