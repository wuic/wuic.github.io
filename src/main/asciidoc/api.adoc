...
This can be achieved by creating a file that contains the class names of different implementations that contains the
implementation class names and called `META-INF/services/com.github.wuic.config.ObjectBuilderInspector`.
