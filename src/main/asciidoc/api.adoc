...
*Note those who don't want use init-param:* you will see the particular `c.g.wuic.initParameterClass` `init-param` in the table below.
...
You have the sample [here](https://github.com/wuic/wuic-samples/tree/wuic-0.5.x-snapshot/js-css-sample).
